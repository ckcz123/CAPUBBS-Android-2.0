...
public class BadgeView extends TextView {
	...
	private static HashMap<Integer, BadgeView> hashMap = new HashMap<Integer, BadgeView>();
	...
	public BadgeView(Context context, AttributeSet attrs, int defStyle, View target, int tabIndex) {
		...
		if (target != null) {
			hashMap.put(context.hashCode() + target.hashCode(), this);
		}
	...
	public void setScale(float scale) {
		...
		setTextSize(TypedValue.COMPLEX_UNIT_SP,
				Util.px2sp(context, (int) getTextSize()) * scale);
	}
	...
	public static void show(Context context, View view, String text) {
		show(context, view, text, 0, 1f);
	}

	public static void show(Context context, View view, String text, int margin,
							float scale) {
		if (context == null || view == null) return;
		if (text == null) text = "";
		BadgeView badgeView = hashMap.get(context.hashCode() + view.hashCode());
		if (badgeView != null)
			badgeView.resetScale();
		else
			badgeView = new BadgeView(context, view);
		badgeView.setBadgeMargin(margin);
		badgeView.setScale(scale);
		try {
